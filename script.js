document.addEventListener('DOMContentLoaded', () => {
  ...
  difficultyButtons.forEach(button => {
    button.addEventListener('click', (e) => {
      ...
      startLabel.style.display = 'block'; // Show the start label
      startGame();
    });
  });
  ...
  function startGameOnKeyPress() {
    gameStarted = true;
    startLabel.style.display = 'none'; // Hide the start label
  ...
  function createPipe() {
    ...
    let pipeSet = {
      topPipe: { el: pipeTop, x: gameContainer.clientWidth, y: 0, width: 40, height: pipeTopHeight },
      bottomPipe: { el: pipeBottom, x: gameContainer.clientWidth, y: gameContainer.clientHeight - pipeBottomHeight, width: 40, height: pipeBottomHeight },
